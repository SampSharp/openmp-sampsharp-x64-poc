...
public abstract class StatelessMarshallerShape(ITypeSymbol nativeType, ITypeSymbol marshallerType, MarshalDirection direction) : MarshallerShape(nativeType, marshallerType, direction)
{
