...
public readonly partial struct IExtensible
{
    ...
    public void RemoveExtension<T>(T extension) where T : IManagedExtension, IAutoGeneratedManagedExtension
    {
        RemoveExtension(new IExtension(extension.GetUnmanaged()));
    }

    public void AddExtension<T>(T extension) where T : IManagedExtension, IAutoGeneratedManagedExtension
    {
    ...
    public T GetExtension<T>() where T : class, IManagedExtension, IAutoGeneratedManagedExtension
    {
    ...
    public T? TryGetExtension<T>() where T : class, IManagedExtension, IAutoGeneratedManagedExtension
    {
        var ext = GetExtension(T.ExtensionId);
        ...
        var handle = ManagedExtensionInterop.GetHandle(ext.Handle);
