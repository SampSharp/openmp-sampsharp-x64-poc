...
public class PlayerTextLabel : Component
{
    ...
    public virtual int Id => _playerTextLabel.GetID();
    ...
    public virtual Vector3 Position => _playerTextLabel.GetPosition();
    ...
    public virtual int VirtualWorld => _playerTextLabel.GetVirtualWorld();
