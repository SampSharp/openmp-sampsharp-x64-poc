...
/// <summary>Provides functionality for controlling the SA:MP server.</summary>
public interface IServerService
{
    /// <summary>Gets the highest actor identifier created on the server.</summary>
    ...
    /// <summary>Returns the up time of the actual server (not the SA-MP server) in milliseconds.</summary>
    /// <remarks>The tick count will eventually overflow after roughly 24 days.</remarks>
    int TickCount { get; }

    /// <summary>Gets the tick rate of the server.</summary>
    ...
    /// <summary>Ends the current game mode.</summary>
    void GameModeExit();
    ...
    /// <summary>Gets the integer value of a console variable.</summary>
    /// <param name="variableName">The name of the variable.</param>
    /// <returns>The value of the specified console variable.</returns>
    ...
    /// <summary>Unblock an IP address that was previously blocked using <see cref="BlockIpAddress" />.</summary>
